...
class _EditItemDialogState extends State<EditItemDialog> {
  ...
  @override
  void initState() {
    billItemData = BillItemData.from(
      widget.billDataProvider.billData.items[widget.index]
    );
    participants = widget.billDataProvider.billData.participants;
    billItemData.participantsData.forEach((key, value) => assignedSlot += value);
    super.initState();
  }
                    ...
                    : (value) {
                        setState(() {
                          if (billItemData.participantsData
                              .containsKey(e)) {
                            assignedSlot -= billItemData.participantsData[e]!.toInt();
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: billItemData.participantsData.entries.map((e) {
                      return Card(
                              ...
                              Row(
                                children: [
                                  IconButton(
                                    ...
                                    ? () {
                                      setState(() {
                                        billItemData.participantsData.update(
                                          e.key, (value) => value-1
                                        );
                                        assignedSlot--;
                                      });
                                  ...
                                  IconButton(
                                    onPressed: assignedSlot < billItemData.quantity
                                    ? () {
                                      setState(() {
                                        billItemData.participantsData.update(
                                          e.key, (value) => value+1
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        onPressed: () {
          ...
          if (form!.validate() && billItemData.participantsData.isNotEmpty) {
            widget.billDataProvider.editItem(widget.index, billItemData);
